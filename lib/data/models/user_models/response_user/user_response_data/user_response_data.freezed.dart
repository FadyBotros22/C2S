...
class _$UserResponseDataImpl implements _UserResponseData {
  const _$UserResponseDataImpl({required this.meta, required this.data});
  ...
  @override
  String toString() {
    return 'UserResponseData(meta: $meta, data: $data)';
  }
...
abstract class _UserResponseData implements UserResponseData {
  const factory _UserResponseData(
      ...
      required final Data data}) = _$UserResponseDataImpl;
